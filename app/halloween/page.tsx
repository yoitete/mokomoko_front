...
export default function HalloweenPage() {
  ...
  // ハロウィン関連の投稿をフィルタリング
  const halloweenPostsWithImages = postsWithImages.filter(
    (post) =>
      (post.tags &&
        post.tags.some(
          (tag) =>
            tag.toLowerCase().includes("ハロウィン") ||
  ...
  console.log("Halloween posts with images:", halloweenPostsWithImages);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {halloweenPostsWithImages.length === 0 ? (
          ...
          <div className="grid grid-cols-2 gap-2">
            {halloweenPostsWithImages.map((post, index) => {
